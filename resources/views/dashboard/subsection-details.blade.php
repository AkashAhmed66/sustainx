<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-neutral-600">{{ $subsection->section->name }}</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="p-4 sm:p-6">
        ...
        <div class="dashboard-card mb-6">
            <div class="p-4">
                <form method="GET" action="{{ route('dashboard.subsection', $subsection) }}" class="flex flex-col sm:flex-row items-end gap-3">
                    <div class="flex-1">
        ...
        @forelse($visualizationData as $index => $data)
            <div class="dashboard-card mb-6">
                <div class="p-6">
                    <!-- Question Header -->
                    <div class="flex items-start justify-between mb-6 pb-4 border-b border-neutral-200">
                        <div class="flex-1">
                            ...
                            <div class="flex items-center gap-3 text-sm text-neutral-600">
                                ...
                                @if($data['question']->unit)
                                    <span class="text-neutral-500">Unit: {{ $data['question']->unit }}</span>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    @if($data['type'] == 1)
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                            ...
                            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 border border-blue-200">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-sm font-medium text-blue-700 mb-1">Total Value</p>
                                        <p class="text-2xl font-bold text-blue-900">
                                            {{ number_format($data['total'] ?? 0, 2) }}
                                            @if($data['question']->unit)
                                                <span class="text-sm font-normal text-blue-700">{{ $data['question']->unit }}</span>
                                            @endif
                                        </p>
                                    </div>
                            ...
                            <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-4 border border-green-200">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-sm font-medium text-green-700 mb-1">Average</p>
                                        <p class="text-2xl font-bold text-green-900">
                                            {{ number_format($data['average'] ?? 0, 2) }}
                                            @if($data['question']->unit)
                                                <span class="text-sm font-normal text-green-700">{{ $data['question']->unit }}</span>
                                            @endif
                                        </p>
                                    </div>
                            ...
                            <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-4 border border-purple-200">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-sm font-medium text-purple-700 mb-1">Data Points</p>
                                        <p class="text-2xl font-bold text-purple-900">
                                            {{ $data['chart_data']->count() }}
                                            <span class="text-sm font-normal text-purple-700">{{ $data['chart_data']->count() == 1 ? 'factory' : 'factories' }}</span>
                                        </p>
                                    </div>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div class="bg-neutral-50 rounded-xl p-4">
                                <h4 class="text-sm font-semibold text-neutral-700 mb-4">Calculated Values by Factory</h4>
                            ...
                            <!-- Comparison Chart -->
                            <div class="bg-neutral-50 rounded-xl p-4">
                                <h4 class="text-sm font-semibold text-neutral-700 mb-4">Actual vs Calculated Values</h4>
                                <div style="position: relative; height: 300px;">
                        ...
                        <div class="bg-neutral-50 rounded-xl p-8 text-center">
                            ...
                            <p class="text-neutral-600">No data available for this question</p>
                        </div>
                        @endif
                    ...
                    @elseif($data['type'] == 2)
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <!-- Pie Chart -->
                            <div class="bg-neutral-50 rounded-xl p-4">
                                <h4 class="text-sm font-semibold text-neutral-700 mb-4">Response Distribution</h4>
                                <div style="position: relative; height: 300px;">
                            ...
                            <!-- Data Table -->
                            <div class="bg-neutral-50 rounded-xl p-4">
                                <h4 class="text-sm font-semibold text-neutral-700 mb-4">Response Summary</h4>
                                <div class="space-y-2">
                                    @foreach($data['chart_data'] as $optionData)
                                        <div class="flex items-center justify-between p-3 bg-white rounded-lg border border-neutral-200">
                                            <span class="text-sm font-medium text-neutral-800">{{ $optionData['option'] }}</span>
        ...
        @empty
            <div class="dashboard-card text-center py-12">
                ...
                <p class="text-neutral-500">No assessment data found for this subsection with the selected filters.</p>
            </div>
        @endforelse
    </div>
