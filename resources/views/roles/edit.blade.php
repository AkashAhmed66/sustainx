                ...
                <form action="{{ route('roles.update', $role) }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" 
                               ...
                               class="w-full px-4 py-3 border border-neutral-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent @error('name') border-red-500 @enderror {{ $role->name === 'admin' ? 'bg-neutral-50' : '' }}"
